...
static const char *fonts[] = {
    ...
    "PT Mono:pixelsize=20:antialias=true:autohint=true",
    "monospace:size=20",
...
static char selbordercolor[] = "#2c2c2c";
static char selbgcolor[] = "#2c2c2c";
...
static const Rule rules[] = {
	...
	*/
	...
	{ "Teams",	NULL,	NULL,	1<<3,	1,	0,	0,	-1 },
	{ "Spotify",	NULL,	NULL,	1<<4,	0,	0,	0,	-1 },
	{ "St",	NULL,	NULL,	0,	0,	1,	0,	-1 },
	{ "St",	NULL,	"work_profile",	0,	0,	0,	1,	-1 },
	{ "Brave",	NULL,	"work_profile",	0,	0,	0,	1,	-1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_d,		spawn,		SHCMD("passmenu-otp") },
    ...
    {MODKEY, XK_c, spawn, SHCMD("work")},
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("sum_working_time") },
	/* V is automatically bound above in STACKKEYS */
	{ MODKEY,			XK_b,		togglebar,	{0} },
	/* { MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD("") }, */
  { MODKEY, XK_n, spawn, SHCMD("st -e ncspot")},
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim screens/pic-full-$(date '+%y%m%d-%H%M-%S').png") },
